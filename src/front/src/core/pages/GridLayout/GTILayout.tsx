...
export const GtiLayout: React.FC<Props> = ({}) => {
    ...
    const layout = [
        ...
        { i: "DrillingInfo", x: 6, y: 0, w: 2, h: 3},
        { i: "DrillingChart", x: 8, y: 0, w: 4, h: 3},

        { i: "stats", x: 3, y: 2, w: 2, h: 2},
        { i: "Notes", x: 5, y: 2, w: 2, h: 2},
        { i: "Alarm", x: 0, y: 2, w: 3, h: 2},
        { i: "Chat", x: 8, y: 2, w: 5, h: 3},
